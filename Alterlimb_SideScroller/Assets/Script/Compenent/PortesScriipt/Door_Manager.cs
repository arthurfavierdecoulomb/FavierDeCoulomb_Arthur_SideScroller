...
public class Door : MonoBehaviour
{
    ...
    [SerializeField] CharaController playerChara;
    ...
    [Header("Porte à sens unique")]
    [SerializeField] bool singleUseDoor = false;
    ...
    void Awake()
    {
        ...
        if (playerChara == null && playerTransform != null)
            playerChara = playerTransform.GetComponentInChildren<CharaController>();

        if (playerChara == null)
            Debug.LogWarning($"[Door] '{name}' n'a pas trouvé de CharaController sur le joueur : le verrou CanInteract sera ignoré.", this);
    ...
    void HandleProximityMode()
    {
        ...
        if (playerChara != null && !playerChara.CanInteract) return;
    ...
    public void CloseDoor()
    {
        ...
        if (singleUseDoor) permanentlyLocked = true;
